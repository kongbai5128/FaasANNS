"""Send SIFT queries directly to the full-search Function Compute baseline."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Send SIFT queries to the full-search baseline")
    ...
    parser.add_argument("--log-file", default="baseline/functions/full_search/test/result/run_queries.csv")
